...
![tests](https://img.shields.io/badge/tests-336%20tests-blue)
...
`equiv-receipt` is one of nine repositories built on that. The whole story, and the objections answered,
